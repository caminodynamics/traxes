...
./target/release/traxes-demo --dev artifacts list

# Step 4: Replay and verify a decision
...
TRAXES creates replayable decision artifacts for every evaluation. You can verify that the same input context and policy version produce the same decision result.

### List Artifacts

View all generated decision artifacts:

```bash
traxes-demo --dev artifacts list
```

### Inspect Latest Artifact

View the most recent decision artifact:
...
Replay a specific decision using its decision ID:
...
```text
[Traxes] Loading artifact: dec_733800f14a7542728196fb189d7507c3
[Traxes] Replaying decision...
...
ORIGINAL DECISION:
  ...
  timestamp: 2026-07-08T06:17:25.419390300+00:00
...
REPLAY DECISION:
  ...
  instance_type: t3.micro
  policy: infra-cost-limit-v1
  timestamp: 2026-07-08T06:18:10.123456700+00:00
...
Replay verification demonstrates that the same input context and policy version produce the same decision result.
